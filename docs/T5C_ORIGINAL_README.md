# Original t5c README (preserved for reference)

This repo was forked from [orion3dgames/t5c](https://github.com/orion3dgames/t5c) (MIT license). Its original README content is preserved here for reference/credit; see the root `README.md` for this project's actual identity and docs.
...
Check out the original devlogs on https://dev.to/orion3d

## Technology
- Babylon.js 6.x.x https://www.babylonjs.com/
- Colyseus 0.15.x https://colyseus.io/
- SQLite 3.x.x https://www.sqlite.org/
