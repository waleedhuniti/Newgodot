...
9. **Real map**: `arrival_clearing` reuses the stock `training_ground` mesh — needs a real environment eventually, possibly built from `art/environments/kaykit-dungeon-remastered/`.
